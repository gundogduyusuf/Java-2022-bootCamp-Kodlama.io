...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (String kelime : mesaj.split(" ")) { // Mesajın kelimelerini alt alta yazar

			System.out.println(kelime);

		}

		System.out.println(mesaj.toLowerCase()); // Mesajın bütün harflerini küçük harfe dönüştürür
		System.out.println(mesaj.toUpperCase()); // Mesajın bütün harflerini büyük harfe dönüştürür

		System.out.println(mesaj.trim()); // Mesajın başındaki ve sonundaki boşlukları alır öyle yazar
